...
class Qatten_SI_Weight(nn.Module):
    def __init__(self, args):
        super(Qatten_SI_Weight, self).__init__()

        self.args = args
        self.n_agents = args.n_agents
        self.n_actions = args.n_actions
        self.state_dim = int(np.prod(args.state_shape))  # chenji
...
class DMAQ_QattenMixer(nn.Module):
    def __init__(self, args):
        ...
        self.si_weight = Qatten_SI_Weight(args)
